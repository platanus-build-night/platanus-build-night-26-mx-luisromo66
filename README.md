# Luis Eduardo Romo Fernandez — Platanus Build Night — Ciudad de México Project
...
- Luis Eduardo Romo Fernandez ([@luisromo66](https://github.com/luisromo66))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-build-night/platanus-build-night-26-mx-luisromo66.git
